...
function placedOrder(formObject) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/orders', formObject).then(function (res) {
    ...
    var myVar;
    if (res.data.message === 'All fields are required') clearTimeout(myVar);
...
var cartCount = document.querySelectorAll('#cartCounter'); // this function is for removing cart items
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); //here we are updating cart (how many items a user selected show in cart)
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_3__["loadStripe"])('pk_test_51IXN2qSDNtfQ52hkYYQIb66EtQxEA7FpcAgnkeh1pji3k4NSAvjZFqsjzLAWRbgy7MGnQd8zfzg6k16s6d0rfNv600cZTqcP3r');
          ...
          case 8:
            ...
            if (paymentForm) {
              paymentForm.addEventListener('submit', function (e) {
                ...
                if (!card) {
                  //ajax
                  Object(_apiService__WEBPACK_IMPORTED_MODULE_4__["placedOrder"])(formObject);
                  return;
                } //verify card
